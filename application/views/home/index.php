...
<head>
    ...
    <title><?= $title; ?></title>
    <link rel="stylesheet" href="<?= base_url('assets/home/'); ?>fontawesome-5.5/css/all.min.css" />
    <link rel="stylesheet" href="<?= base_url('assets/home/'); ?>slick/slick.css">
    <link rel="stylesheet" href="<?= base_url('assets/home/'); ?>slick/slick-theme.css">
    <link rel="stylesheet" href="<?= base_url('assets/home/'); ?>magnific-popup/magnific-popup.css">
    <link rel="stylesheet" href="<?= base_url('assets/home/'); ?>css/bootstrap.min.css" />
    <link rel="stylesheet" href="<?= base_url('assets/home/'); ?>css/tooplate-infinite-loop.css" />
...
<body>
    ...
    <section id="infinite" class="text-white tm-font-big tm-parallax">
        ...
        <nav class="navbar navbar-expand-md tm-navbar" id="tmNav">
            <div class="container">
                <div class="tm-next">
                    <a href="#infinite" class="navbar-brand">Produk SMK N Jawa Tengah</a>
                </div>
        ...
        <div class="text-center tm-hero-text-container">
            <div class="tm-hero-text-container-inner">
                <h2 class="tm-hero-title">Produk SMK N Jawa Tengah</h2>
        ...
        <div class="container tm-container-gallery">
            <div class="row">
                <div class="text-center col-12">
                    <h2 class="tm-text-primary tm-section-title mb-4">Our Product</h2>
                            ...
                            <?php foreach ($product as $c) : ?>
                                <a href="img/gallery-img-01.jpg">
                                    <figure class="effect-honey tm-gallery-item">
                                        <img src="<?= base_url('assets/img/product/') . $c['image']; ?>" alt="Image 1" class="img-fluid" width="700px">
                                        <figcaption>
                                            <h2><i><?= $c['description']; ?> <span><?= $c['jurusan']; ?></span></i></h2>
                                        </figcaption>
                                    </figure>
                                </a>
                            <?php endforeach; ?>
    ...
    <script src="<?= base_url('assets/home/'); ?>js/jquery-1.9.1.min.js"></script>
    <script src="<?= base_url('assets/home/'); ?>slick/slick.min.js"></script>
    <script src="<?= base_url('assets/home/'); ?>magnific-popup/jquery.magnific-popup.min.js"></script>
    <script src="<?= base_url('assets/home/'); ?>js/easing.min.js"></script>
    <script src="<?= base_url('assets/home/'); ?>js/jquery.singlePageNav.min.js"></script>
